...
client.on('ready', () => {
    client.user.setGame('SystemBoT صيانة حاليا','https://www.twitch.tv/SystemBOT');
    console.log('---------------');
...
const embed = new Discord.RichEmbed()
   .setAuthor(`اسم البوت Bot left a server ❎`)
   .setDescription(`**
...
Servers Counter : __${client.guilds.size}__**`)
         ...
         .setFooter('اسم البوت' , client.user.avatarURL)
           client.channels.get("ايدي الشات").send({embed});
}
...
client.on('guildCreate', guild => {
  ...
  client.channels.get("ايدي الشات")
const embed = new Discord.RichEmbed()
...
client.on("message", async message => { //حقوق سوبريم
    ...
    if (command == "leave") { //حقوق سوبريم
        ...
        if(message.author.id != " حط ايديك ") return message.reply("**Sorry, you don't have permission to use this!**");  //حقوق سوبريم
